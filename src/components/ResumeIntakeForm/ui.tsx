	...
	<div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-4">
		{onClose ? (
			<div className="w-full h-full relative flex justify-end">
				<button onClick={onClose} className="p-1 rounded group">
...
export const AddButton = ({ id, children, onClick }: AddButtonProps) => (
	<button id={id} onClick={onClick} className="px-4 py-2 rounded-lg bg-purple-600/80 hover:bg-purple-600 transition">
		{children}
	</button>
)
