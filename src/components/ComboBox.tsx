...
export default function ComboBox(props: ComboBoxProps) {
	...
	const filtered = query === '' ? items : items.filter((item) => item.toLowerCase().includes(query.toLowerCase()))
				...
				<div className="relative">
					...
					>
						{filtered.length === 0 && !allowCreate && (
							<div className="cursor-default px-4 py-2 text-gray-500">No results</div>
						)}
