		...
		<div className="relative w-full h-[70vh] flex flex-col items-center justify-start overflow-hidden bg-gradient-to-br from-darkest via-darker to-darkest">
			...
			<div className="h-full w-full flex items-center justify-center">
				<div className="relative z-10 text-center px-6 max-w-2xl">
					<h1 className="text-white text-4xl font-bold mb-4">Build Beautiful Resumes, Fast</h1>
			...
			<div className="max-w-6xl mx-auto px-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					{features.map((feature) => (
						<div
							key={feature.title}
							className="p-6 bg-gradient-to-tr from-dark/20 via-dark/70 to-primary/50 rounded-2xl shadow hover:shadow-lg transition"
						>
