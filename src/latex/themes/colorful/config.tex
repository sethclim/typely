...
\def\hrulefill{\leavevmode\leaders\hrule height 1.4pt\hfill\kern 0pt}
...
%--------------------------
% #1 = Project Name
% #2 = Role / Short description
% #3 = Git URL (appears on the right)
% #4 = Details / Description
\newcommand{\CVMiniProject}[4]{
    \tab \texttt{\Large \textbf{#1}} \hfill \href{#3}{\textcolor{red}{\faIcon{github} Repo}}\\
    \tab \textbf{#2}\\
    \ifthenelse{\isempty{#4}}{\\}{\tab \begin{minipage}{14cm}#4\end{minipage}\\~\\}
}