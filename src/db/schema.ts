...
export const templateThemeIdx = index('idx_template_theme').on(template.themeId)
...
export const resumeConfigThemeIdx = index('idx_resume_theme').on(resumeConfig.themeId)
...
export const resumeSectionTemplateIdx = index('idx_section_template').on(resumeSectionConfig.templateId)
...
export const resumeDataItemTypeIdx = index('idx_data_type').on(resumeDataItem.typeId)
